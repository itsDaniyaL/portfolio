...
export default function PrivacyPolicy() {
  ...
  const toc = [
    ...
    },
    {
      ...
      label: "Collecting & Using Your Personal Data",
    },
          ...
          <article className="rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-sm">
            <div className="p-6 sm:p-8 lg:p-12">
              <p className="text-base leading-7 text-zinc-700 dark:text-zinc-300">
                ...
                . © 2024 Broken Umbrella Games by Afzaal Ahmad Zeeshan.
              </p>

              <p className="mt-6 text-base leading-7 text-zinc-700 dark:text-zinc-300">
                This Privacy Policy describes our policies and procedures on the
                collection, use, and disclosure of your information when you use
                the Service—plus your privacy rights and how the law protects
                you.
              </p>
              ...
              <Section id="who-we-are" title="Who we are">
                <p>
                  Broken Umbrella Games (by Afzaal Ahmad Zeeshan) operates the
              ...
              >
                ...
                <ul className="list-disc pl-5 space-y-2">
                  ...
                  <li>
                    <strong>Application</strong> refers to applications
                    developed by Broken Umbrella Games (by Afzaal Ahmad
                    Zeeshan), the software program provided by the Company.
                  </li>
                  <li>
                    <strong>Company</strong> (referred to as either “the
                    Company”, “We”, “Us” or “Our” in this Agreement) refers to
                    Broken Umbrella Games (by Afzaal Ahmad Zeeshan).
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    any website or social network through which a User can log
                  ...
                  <li>
                    <strong>Website</strong> refers to Broken Umbrella Games (by
                    Afzaal Ahmad Zeeshan), accessible from{" "}
                    <a
                      href="https://brokenumbrellagames.com"
                      target="_blank"
                      rel="noreferrer noopener"
              ...
              >
                ...
                <p>
                  ...
                  and may include your IP address, browser type/version, pages
                  visited, time/date of visits, time spent on pages, unique
                  device identifiers, and other diagnostic data. On mobile,
                  collection may include device type, unique ID, IP, OS, browser
                ...
                <p>
                  The Company allows you to create an account and log in using
                ...
                <p>
                  ...
                  with that account (e.g., name, email, activities, contact
                  list). If you voluntarily share additional information, you
                  allow the Company to use, share, and store it consistent with
                  this Privacy Policy.
                </p>
                ...
                <p>
                  With your prior permission, we may collect information
                  regarding your location to provide features, improve, and
                  customize the Service. Data may be uploaded to Company or
                  Service Provider servers, or stored on your device. You can
                  enable/disable access anytime via device settings.
                </p>
                ...
                <p>
                  We use cookies and similar technologies (beacons, tags,
                  scripts) to track activity and store information to improve
                ...
                <ul className="list-disc pl-5 space-y-2">
                  ...
                  <li>
                    ...
                    pages/emails to count visits/opens and for related
                    statistics.
                  </li>
                </ul>
                <p>
                ...
                <p className="mt-4">
                  We use both Session and Persistent Cookies for purposes such
                  as:
                </p>
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                  ...
                  <li>
                    <strong>Functionality Cookies</strong> – remember choices
                    like login details or language preferences.
                  </li>
                </ul>
              </Section>
              ...
              >
                ...
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                    Provide and maintain our Service (including usage
                    monitoring).
                  </li>
                  ...
                  <li>
                    Other purposes: analysis, trends, campaign effectiveness,
              ...
              <Section id="retention" title="Retention of Your Personal Data">
                <p>
                  The Company retains Personal Data only as long as necessary
                  for the purposes set out in this Policy and to comply with
                  legal obligations, resolve disputes, and enforce agreements.
                  Usage Data is generally retained for a shorter period unless
                  needed for security, functionality, or legal obligations.
                </p>
              </Section>
              ...
              <Section id="delete" title="Delete Your Personal Data">
                <p>
                  You may delete certain information from within the Service.
                  You can update, amend, or delete your information via account
                  settings (if applicable) or by contacting us. We may retain
                  some information where we have a legal obligation or lawful
                  basis.
                </p>
              </Section>
              ...
              <Section id="disclosure" title="Disclosure of Your Personal Data">
                ...
                <p>
                  ...
                  sale, your Personal Data may be transferred with notice
                  provided beforehand.
                </p>
                <h4 className="mt-6 text-lg font-semibold text-zinc-900 dark:text-zinc-100">
                  Law Enforcement
              ...
              <Section id="contact" title="Contact Us">
                ...
                <ul className="list-disc pl-5 space-y-2">
                  <li>
                    ...
                    <a
                      href="https://brokenumbrellagames.com/contact"
                      target="_blank"
                      rel="noreferrer noopener"
                      className="underline decoration-emerald-500/40 underline-offset-4 hover:decoration-emerald-500"
                    >
                  ...
                  <li>
                    By email:{" "}
                    <a
                      href="mailto:contact@brokenumbrellagames.com"
                      className="underline decoration-emerald-500/40 underline-offset-4 hover:decoration-emerald-500"
                    >
                      contact@brokenumbrellagames.com
                    </a>
                  </li>
                </ul>
              </Section>
              ...
              <div className="mt-10">
                <a
                  href="#top"
                  className="inline-flex items-center gap-2 rounded-xl border border-zinc-200 dark:border-zinc-800 px-4 py-2 text-sm font-medium text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500"
                >
                  ↑ Back to top
                </a>
              </div>
