  ...
  return (
    ...
    >
      <div className="wp-block-group has-global-padding is-layout-constrained wp-block-group-is-layout-constrained">
        ...
        <h1 className="has-text-align-center wp-block-post-title">
          Privacy Policy
        </h1>
      ...
      <div className="entry-content wp-block-post-content has-global-padding is-layout-constrained wp-block-post-content-is-layout-constrained">
        ...
        <p>
          Our website address is: https://brokenumbrellagames.com. © 2024 Broken
          Umbrella Games by Afzaal Ahmad Zeeshan.
        </p>

        <h4 className="wp-block-heading">Last updated: November 21, 2024</h4>
        ...
        <h2 className="wp-block-heading">Interpretation and Definitions</h2>

        <h3 className="wp-block-heading">Interpretation</h3>
        ...
        <h3 className="wp-block-heading">Definitions</h3>
        ...
        <ul className="wp-block-list">
          ...
          <li>
            ...
            by Broken Umbrella Games (by Afzaal Ahmad Zeeshan), the software
            program provided by the Company.
          </li>

          <li>
            <strong>Company</strong>&nbsp;(referred to as either “the Company”,
            “We”, “Us” or “Our” in this Agreement) refers to Broken Umbrella
            Games (by Afzaal Ahmad Zeeshan).
          </li>
        ...
        <h3 className="wp-block-heading">Types of Data Collected</h3>

        <h4 className="wp-block-heading">Personal Data</h4>
        ...
        <h4 className="wp-block-heading">Usage Data</h4>
        ...
        <h4 className="wp-block-heading">Tracking Technologies and Cookies</h4>
        ...
        <h3 className="wp-block-heading">Use of Your Personal Data</h3>
        ...
        <h3 className="wp-block-heading">Retention of Your Personal Data</h3>
        ...
        <h3 className="wp-block-heading">Transfer of Your Personal Data</h3>
        ...
        <h3 className="wp-block-heading">Delete Your Personal Data</h3>
        ...
        <h3 className="wp-block-heading">Disclosure of Your Personal Data</h3>

        <h4 className="wp-block-heading">Business Transactions</h4>
        ...
        <h4 className="wp-block-heading">Law enforcement</h4>
        ...
        <h4 className="wp-block-heading">Other legal requirements</h4>
        ...
        <h3 className="wp-block-heading">Security of Your Personal Data</h3>
        ...
        <h2 className="wp-block-heading">Links to Other Websites</h2>
        ...
        <h2 className="wp-block-heading">Changes to this Privacy Policy</h2>
        ...
        <p>By email: contact@brokenumbrellagames.com</p>
